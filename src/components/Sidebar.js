...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col gap-2 items-center w-fit">
      <div
        onClick={handleShare}
        className="text-white p-2 bg-[#1890FF] rounded-md flex items-center gap-2 w-fit flex-col"
      >
        <button className="text-white [writing-mode:vertical-lr] transform rotate-180">
          Chia sẻ
        </button>
      ...
      <div
        onClick={handleRedo}
        className="bg-white rounded-md w-full h-10 flex items-center justify-center"
      >
        <button aria-label="Redo Quiz">
